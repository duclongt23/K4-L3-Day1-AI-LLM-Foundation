...
def compare_models(prompt: str) -> dict:
    ...
    gpt4o_result = call_openai(prompt=prompt)
    mini_result = call_openai_mini(prompt=prompt)
    gpt4o_cost = (len(gpt4o_result[0].split()) / 0.75) / 1000 \
           * PRICING_PER_1K_TOKENS["gpt-4o"]["output"]
    return {
        "gpt4o_response": gpt4o_result[0],
        "mini_response": mini_result[0],
        "gpt4o_latency": gpt4o_result[1],
        "mini_latency": mini_result[1],
